...
################################################################################################################
# Code to link python with Excel sheets
...
################################################################################################################
# Bootstrap part of the code - To find the distribution of EBIT/Pre WC-CFO multiple
# Bootstrap function
...
# Plotting bootstrapped data histogram (YOU CAN COMMENT THE BELOW CODE OUT TO SEE THE BOOTSTRAP DISTRIBUTION)
...
# Function to assign distributions to inputs (Risk-free rate, ERP, CFO-Pre WC)
def change_inputs():
    global risk_free
...
lst_outputs = []
# Simulations
for i in range(10000):  # Just change the range to the number of simulations you would like to have
    change_inputs()
...
# Output Distribution of WACC at 60% Leverage ratio
